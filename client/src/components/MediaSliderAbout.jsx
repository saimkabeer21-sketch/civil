...
const mediaItems = [
  { type: 'image', src: '/media2/WhatsApp Image 2026-03-13 at 12.29.04 AM.jpeg' },
  { type: 'image', src: '/media2/WhatsApp Image 2026-03-13 at 12.29.04 AM (1).jpeg' },
  { type: 'image', src: '/media2/WhatsApp Image 2026-03-13 at 12.29.04 AM (2).jpeg' },
  { type: 'image', src: '/media2/WhatsApp Image 2026-03-13 at 12.29.04 AM (3).jpeg' },
  { type: 'image', src: '/media2/WhatsApp Image 2026-03-13 at 12.29.05 AM.jpeg' },
  { type: 'image', src: '/media2/WhatsApp Image 2026-03-13 at 12.32.10 AM (1).jpeg' },
  { type: 'image', src: '/media2/WhatsApp Image 2026-03-13 at 12.32.10 AM (2).jpeg' },
  { type: 'image', src: '/media2/WhatsApp Image 2026-03-13 at 12.32.10 AM (3).jpeg' },
  { type: 'image', src: '/media2/WhatsApp Image 2026-03-13 at 12.32.10 AM.jpeg' },
  { type: 'image', src: '/media2/WhatsApp Image 2026-03-13 at 12.32.11 AM.jpeg' }
];

export default function MediaSliderAbout() {
  ...
  return (
    <>
      <div 
        className="relative group w-full h-[460px] sm:h-[520px] lg:h-[600px] rounded-[1.8rem] lg:rounded-[2.2rem] overflow-hidden shadow-2xl shadow-slate-200 bg-slate-100"
        ...
        {isLightboxOpen && (
          ...
          >
            ...
            <div className="relative w-full max-w-6xl max-h-screen flex items-center justify-center">
              ...
              <button
                onClick={goToPrev}
                className="absolute left-0 sm:-left-12 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-white/20 transition-colors z-[110]"
              >
                <ChevronLeft size={24} />
              </button>
              ...
              <button
                onClick={goToNext}
                className="absolute right-0 sm:-right-12 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-white/20 transition-colors z-[110]"
              >
                <ChevronRight size={24} />
              </button>
            </div>
